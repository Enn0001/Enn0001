...
<!--
    var product1 = document.getElementById("product1")
            ...
            if (parseFloat(qty4.value) > 0){
                    var order = qty4.value.toString() + ' pc/s x ' + price4.textContent + '------' + product4.textContent + '------ Php' + (parseFloat(qty4.value)*parseFloat(price3.textContent)) + '\n'
                    //carts.textContent += carts.value.toString() + "\n";
                    carts.textContent += order
            }
                if (parseFloat(qty5.value) > 0){
                    var order = qty5.value.toString() + ' pc/s x ' + price5.textContent + '------' + product5.textContent + '------ Php' + (parseFloat(qty5.value)*parseFloat(price3.textContent)) + '\n'
                    //carts.textContent += carts.value.toString() + "\n";
                    carts.textContent += order
            }
...
-->
    ...
    qty1.addEventListener("keyup", updateOrderList);
    qty2.addEventListener("keyup", updateOrderList);
    qty3.addEventListener("keyup", updateOrderList);
    qty4.addEventListener("keyup", updateOrderList);
    qty5.addEventListener("keyup", updateOrderList);
    qty6.addEventListener("keyup", updateOrderList);
